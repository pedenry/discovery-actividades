...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-0 sm:right-auto sm:top-auto sm:left-1/2 sm:-translate-x-1/2 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
